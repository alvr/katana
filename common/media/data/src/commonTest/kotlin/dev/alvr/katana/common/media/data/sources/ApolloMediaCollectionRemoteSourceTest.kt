...
internal class ApolloMediaCollectionRemoteSourceTest : FreeSpec() {
    ...
    private lateinit var source: MediaCollectionRemoteSource
        ...
        "anime" -
            {
                "the collection has no lists" {
                    ...
                    source.animeCollection(MediaListStatus.All).test {
        ...
        "manga" -
            {
                "the collection has no lists" {
                    ...
                    source.mangaCollection(MediaListStatus.All).test {
                        awaitItem().shouldBeRight().lists.shouldBeEmpty()
                        awaitComplete()
                    }
