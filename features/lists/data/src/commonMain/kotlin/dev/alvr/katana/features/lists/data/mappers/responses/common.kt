...
internal fun Number.toLocalDateTime() = Instant.fromEpochMilliseconds(toLong() * TO_UNIX).toLocalDateTime(TimeZone.UTC)

internal fun <R> MediaType.onMediaEntry(anime: () -> R, manga: () -> R): R =
    when (this) {
